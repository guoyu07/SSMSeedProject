!function ($) {
    ...
    var AsynchronousLoading = function (href) {
        $.ajax({
            type: 'GET', //提交的类型
            url: href,//提交地址
    ...
    Sidemenu.prototype.openLeftBar = function () {
        ...
        Sidemenu.prototype.menuItemClick = function (e) {
            ...
            if (!$("#wrapper").hasClass("enlarged")) {
                ...
                /**
                 * 如果不能再展开就请求页面然后替换 这里是个坑，改的话请万分小心
                 */
                 ...
                 * 如果菜单收缩起来后
                 */
                if (!$(this).hasClass("waves-effect")) {//菜单为可以点击的菜单
                    AsynchronousLoading(href);
                    return false;
                }
                if ($(this).hasClass("home")) {//单层菜单
                    AsynchronousLoading(href);
                    return false;
                }
            }
    ...
    function ($) {
        ...
        var MoltranApp = function () {
            this.VERSION = "1.0",
                ...
                this.SUPPORT = "izhangzhihao@hotmail.com",
